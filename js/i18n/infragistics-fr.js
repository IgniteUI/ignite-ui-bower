...
*
*/
(function(factory){if(typeof define==="function"&&define.amd){define(["jquery"],factory)}else{factory(jQuery)}})(function($){$.ig=$.ig||{};if(!$.ig.Notifier){$.ig.Notifier={};$.extend($.ig.Notifier,{locale:{successMsg:"R\xe9ussite",errorMsg:"Erreur",warningMsg:"Avertissement",notSupportedState:"\xc9tat de notification non pris en charge\xa0! Utilisez un des \xe9tats pris en charge 'success', 'info', 'warning', 'error'",notSupportedMode:"Mode de notification non pris en charge\xa0! Utilisez un des modes pris en charge 'auto', 'popover', 'inline'"}})}});/*!@license
