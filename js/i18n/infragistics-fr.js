...
*
*/
(function(factory){if(typeof define==="function"&&define.amd){define(["jquery"],factory)}else{factory(jQuery)}})(function($){$.ig=$.ig||{};if(!$.ig.Templating){$.ig.Templating={};$.extend($.ig.Templating,{locale:{undefinedArgument:"Une erreur s'est produite pendant la r\xe9cup\xe9ration de la propri\xe9t\xe9 de la source de donn\xe9es\xa0: "}})}});/*!@license
...
*
*/
(function(factory){if(typeof define==="function"&&define.amd){define(["jquery"],factory)}else{factory(jQuery)}})(function($){$.ig=$.ig||{};if(!$.ig.Dialog){$.ig.Dialog={locale:{closeButtonTitle:"Fermer",minimizeButtonTitle:"Minimiser",maximizeButtonTitle:"Maximiser",pinButtonTitle:"Punaiser",unpinButtonTitle:"D\xe9punaiser",restoreButtonTitle:"Restaurer",setOptionError:"Les modifications de temps d'ex\xe9cution ne sont pas autoris\xe9es pour l'option suivante\xa0: "}}}});/*!@license
...
*
*/
(function(factory){if(typeof define==="function"&&define.amd){define(["jquery"],factory)}else{factory(jQuery)}})(function($){$.ig=$.ig||{};if(!$.ig.Notifier){$.ig.Notifier={};$.extend($.ig.Notifier,{locale:{successMsg:"R\xe9ussite",errorMsg:"Erreur",warningMsg:"Avertissement"}})}});/*!@license
...
*
*/
(function(factory){if(typeof define==="function"&&define.amd){define(["jquery"],factory)}else{factory(jQuery)}})(function($){$.ig=$.ig||{};if(!$.ig.Popover){$.ig.Popover={};$.extend($.ig.Popover,{locale:{popoverOptionChangeNotSupported:"La modification de l'option suivante apr\xe8s l'initialisation de FinPopig n'est pas prise en charge\xa0:",popoverShowMethodWithoutTarget:"Le param\xe8tre target de la fonction show est obligatoire lorsque l'option selectors est utilis\xe9e"}})}});/*!@license
...
*
*/
(function(factory){if(typeof define==="function"&&define.amd){define(["jquery"],factory)}else{factory(jQuery)}})(function($){$.ig=$.ig||{};if(!$.ig.Rating){$.ig.Rating={};$.extend($.ig.Rating,{locale:{setOptionError:"Les modifications de temps d'ex\xe9cution ne sont pas autoris\xe9es pour l'option suivante\xa0: "}})}});/*!@license
...
*
*/
(function(factory){if(typeof define==="function"&&define.amd){define(["jquery"],factory)}else{factory(jQuery)}})(function($){$.ig=$.ig||{};if(!$.ig.Scroll){$.ig.Scroll={};$.extend($.ig.Scroll,{locale:{errorNoElementLink:"L'\xe9l\xe9ment en cours de liaison n'existe pas.",errorNoScrollbarLink:"L'\xe9l\xe9ment de la barre de d\xe9filement en cours de liaison n'existe pas."}})}});/*!@license
...
*
*/
(function(factory){if(typeof define==="function"&&define.amd){define(["jquery"],factory)}else{factory(jQuery)}})(function($){$.ig=$.ig||{};if(!$.ig.Splitter){$.ig.Splitter={};$.extend($.ig.Splitter,{locale:{errorPanels:"Le nombre de panneaux ne doit pas \xeatre sup\xe9rieur \xe0 deux.",errorSettingOption:"Erreur lors du r\xe9glage de l'option."}})}});/*!@license
...
*
*/
(function(factory){if(typeof define==="function"&&define.amd){define(["jquery"],factory)}else{factory(jQuery)}})(function($){$.ig=$.ig||{};if(!$.ig.TileManager){$.ig.TileManager={};$.extend($.ig.TileManager,{locale:{renderDataError:"\xc9chec de la r\xe9cup\xe9ration ou de l'analyse des donn\xe9es.",setOptionItemsLengthError:"The length of the items configurations does not match the number of the tiles."}})}});/*!@license
...
*
*/
(function(factory){if(typeof define==="function"&&define.amd){define(["jquery"],factory)}else{factory(jQuery)}})(function($){$.ig=$.ig||{};if(!$.ig.Toolbar){$.ig.Toolbar={};$.extend($.ig.Toolbar,{locale:{collapseButtonTitle:"R\xe9duire",expandButtonTitle:"Etendre"}})}});/*!@license
...
*
*/
(function(factory){if(typeof define==="function"&&define.amd){define(["jquery"],factory)}else{factory(jQuery)}})(function($){$.ig=$.ig||{};if(!$.ig.Tree){$.ig.Tree={};$.extend($.ig.Tree,{locale:{invalidArgumentType:"Type d'argument fourni invalide.",errorOnRequest:"Une erreur s'est produite pendant la r\xe9cup\xe9ration des donn\xe9es\xa0: ",noDataSourceUrl:"La commande igTree requiert une dataSourceUrl pour initier une requ\xeate de donn\xe9es pour cette URL.",incorrectPath:"Un n\u0153ud a \xe9t\xe9 trouv\xe9 sur le chemin fourni\xa0: ",incorrectNodeObject:"L'argument fourni n'est pas un \xe9l\xe9ment de n\u0153ud jQuery.",setOptionError:"Les modifications de temps d'ex\xe9cution ne sont pas autoris\xe9es pour l'option suivante\xa0: ",moveTo:"<strong>D\xe9placer vers</strong> {0}",moveBetween:"<strong>D\xe9placer entre</strong> {0} et {1}",moveAfter:"<strong>D\xe9placer apr\xe8s</strong> {0}",moveBefore:"<strong>D\xe9placer avant</strong> {0}",copyTo:"<strong>Copier vers</strong> {0}",copyBetween:"<strong>Copier entre</strong> {0} et {1}",copyAfter:"<strong>Copier apr\xe8s</strong> {0}",copyBefore:"<strong>Copier avant</strong> {0}",and:"et"}})}});/*!@license
