/*!@license
* Infragistics.Web.ClientUI data source localization resources 17.2.0-beta.1
*
...
*
*/
(function(factory){if(typeof define==="function"&&define.amd){define([],factory)}else{factory()}})(function(){$=$||{};$.ig=$.ig||{};$.ig.locale=$.ig.locale||{};$.ig.locale.en=$.ig.locale.en||{};$.ig.SharedLocale=$.ig.SharedLocale||{};$.ig.locale.en.SharedLocale={};$.ig.SharedLocale.locale=$.ig.SharedLocale.locale||$.ig.locale.en.SharedLocale;return $.ig.locale.en.SharedLocale});/*!@license
* Infragistics.Web.ClientUI templating localization resources 17.2.0-beta.1
*
* Copyright (c) 2011-2017 Infragistics Inc.
*
* http://www.infragistics.com/
*
*/
(function(factory){if(typeof define==="function"&&define.amd){define([],factory)}else{factory()}})(function(){$=$||{};$.ig=$.ig||{};$.ig.locale=$.ig.locale||{};$.ig.locale.en=$.ig.locale.en||{};$.ig.Templating=$.ig.Templating||{};$.ig.locale.en.Templating={undefinedArgument:"An error has occurred while trying to retrieve data source property: "};$.ig.Templating.locale=$.ig.Templating.locale||$.ig.locale.en.Templating;return $.ig.locale.en.Templating});/*!@license
* Infragistics.Web.ClientUI Combo localization resources 17.2.0-beta.1
*
* Copyright (c) 2011-2017 Infragistics Inc.
*
* http://www.infragistics.com/
*
*/
(function(factory){if(typeof define==="function"&&define.amd){define([],factory)}else{factory()}})(function(){$=$||{};$.ig=$.ig||{};$.ig.locale=$.ig.locale||{};$.ig.locale.en=$.ig.locale.en||{};$.ig.Combo=$.ig.Combo||{};$.ig.locale.en.Combo={noMatchFoundText:"No matches found",dropDownButtonTitle:"Show drop-down",clearButtonTitle:"Clear value",placeHolder:"select...",notSuported:"Operation is not supported.",errorNoSupportedTextsType:"A different filtering text is required. Provide a value that is either a string or an array of strings.",errorUnrecognizedHighlightMatchesMode:"A different highlight matches mode is required. Choose a value between 'multi', 'contains', 'startsWith', 'full' and 'null'.",errorIncorrectGroupingKey:"Grouping key is not correct."};$.ig.Combo.locale=$.ig.Combo.locale||$.ig.locale.en.Combo;return $.ig.locale.en.Combo});/*!@license
...
*
*/
(function(factory){if(typeof define==="function"&&define.amd){define([],factory)}else{factory()}})(function(){$=$||{};$.ig=$.ig||{};$.ig.locale=$.ig.locale||{};$.ig.locale.en=$.ig.locale.en||{};$.ig.Dialog=$.ig.Dialog||{};$.ig.locale.en.Dialog={closeButtonTitle:"Close",minimizeButtonTitle:"Minimize",maximizeButtonTitle:"Maximize",pinButtonTitle:"Pin",unpinButtonTitle:"Unpin",restoreButtonTitle:"Restore",setOptionError:"Runtime changes are not allowed for the following option: "};$.ig.Dialog.locale=$.ig.Dialog.locale||$.ig.locale.en.Dialog;return $.ig.locale.en.Dialog});/*!@license
* Infragistics.Web.ClientUI Editors localization resources 17.2.0-beta.1
*
* Copyright (c) 2011-2017 Infragistics Inc.
*
* http://www.infragistics.com/
...
*
*/
(function(factory){if(typeof define==="function"&&define.amd){define([],factory)}else{factory()}})(function(){$=$||{};$.ig=$.ig||{};$.ig.locale=$.ig.locale||{};$.ig.locale.en=$.ig.locale.en||{};$.ig.Notifier=$.ig.Notifier||{};$.ig.locale.en.Notifier={successMsg:"Success",errorMsg:"Error",warningMsg:"Warning",infoMsg:"Information",notSupportedState:"Not supported notification state! Use one of the supported states 'success', 'info', 'warning', 'error'",notSupportedMode:"Not supported notification mode! Use one of the supported modes 'auto', 'popover', 'inline'"};$.ig.Notifier.locale=$.ig.Notifier.locale||$.ig.locale.en.Notifier;return $.ig.locale.en.Notifier});/*!@license
* Infragistics.Web.ClientUI Popover localization resources 17.2.0-beta.1
*
* Copyright (c) 2011-2017 Infragistics Inc.
*
* http://www.infragistics.com/
...
*
*/
(function(factory){if(typeof define==="function"&&define.amd){define([],factory)}else{return factory()}})(function(){$=$||{};$.ig=$.ig||{};$.ig.Rating=$.ig.Rating||{};$.ig.locale=$.ig.locale||{};$.ig.locale.en=$.ig.locale.en||{};$.ig.locale.en.Rating={setOptionError:"Runtime changes are not allowed for the following option: "};$.ig.Rating.locale=$.ig.Rating.locale||$.ig.locale.en.Rating;return $.ig.locale.en.Rating});/*!@license
* Infragistics.Web.ClientUI Scroll localization resources 17.2.0-beta.1
*
* Copyright (c) 2011-2017 Infragistics Inc.
*
* http://www.infragistics.com/
...
* Infragistics.Web.ClientUI Splitter localization resources 17.2.0-beta.1
*
* Copyright (c) 2011-2017 Infragistics Inc.
*
* http://www.infragistics.com/
...
* Infragistics.Web.ClientUI Tree localization resources 17.2.0-beta.1
*
* Copyright (c) 2011-2017 Infragistics Inc.
*
* http://www.infragistics.com/
...
* Infragistics.Web.ClientUI Upload localization resources 17.2.0-beta.1
*
* Copyright (c) 2011-2017 Infragistics Inc.
*
* http://www.infragistics.com/
...
* Infragistics.Web.ClientUI Validator localization resources 17.2.0-beta.1
*
* Copyright (c) 2011-2017 Infragistics Inc.
*
* http://www.infragistics.com/
...
* Infragistics.Web.ClientUI Video Player localization resources 17.2.0-beta.1
*
* Copyright (c) 2011-2017 Infragistics Inc.
*
* http://www.infragistics.com/
...
* Infragistics.Web.ClientUI common utilities localization resources 17.2.0-beta.1
*
* Copyright (c) 2011-2017 Infragistics Inc.
*
* http://www.infragistics.com/
