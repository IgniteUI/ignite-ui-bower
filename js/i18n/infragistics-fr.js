...
*
*/
(function($){$.ig=$.ig||{};if(!$.ig.Templating){$.ig.Templating={};$.extend($.ig.Templating,{locale:{undefinedArgument:"Une erreur s'est produite pendant la r\xe9cup\xe9ration de la propri\xe9t\xe9 de la source de donn\xe9es\xa0: "}})}})(jQuery);/*!@license
...
*
*/
(function($){$.ig=$.ig||{};if(!$.ig.Dialog){$.ig.Dialog={locale:{closeButtonTitle:"Fermer",minimizeButtonTitle:"Minimiser",maximizeButtonTitle:"Maximiser",pinButtonTitle:"Punaiser",unpinButtonTitle:"D\xe9punaiser",restoreButtonTitle:"Restaurer",setOptionError:"Les modifications de temps d'ex\xe9cution ne sont pas autoris\xe9es pour l'option suivante\xa0: "}}}})(jQuery);/*!@license
...
*
*/
(function($){$.ig=$.ig||{};if(!$.ig.Notifier){$.ig.Notifier={};$.extend($.ig.Notifier,{locale:{successMsg:"R\xe9ussite",errorMsg:"Erreur",warningMsg:"Avertissement"}})}})(jQuery);/*!@license
...
*
*/
(function($){$.ig=$.ig||{};if(!$.ig.Popover){$.ig.Popover={};$.extend($.ig.Popover,{locale:{popoverOptionChangeNotSupported:"La modification de l'option suivante apr\xe8s l'initialisation de FinPopig n'est pas prise en charge\xa0:",popoverShowMethodWithoutTarget:"Le param\xe8tre target de la fonction show est obligatoire lorsque l'option selectors est utilis\xe9e"}})}})(jQuery);/*!@license
...
*
*/
(function($){$.ig=$.ig||{};if(!$.ig.Rating){$.ig.Rating={};$.extend($.ig.Rating,{locale:{setOptionError:"Les modifications de temps d'ex\xe9cution ne sont pas autoris\xe9es pour l'option suivante\xa0: "}})}})(jQuery);/*!@license
...
*
*/
(function($){$.ig=$.ig||{};if(!$.ig.Scroll){$.ig.Scroll={};$.extend($.ig.Scroll,{locale:{errorNoElementLink:"L'\xe9l\xe9ment en cours de liaison n'existe pas.",errorNoScrollbarLink:"L'\xe9l\xe9ment de la barre de d\xe9filement en cours de liaison n'existe pas."}})}})(jQuery);/*!@license
...
*
*/
(function($){$.ig=$.ig||{};if(!$.ig.Splitter){$.ig.Splitter={};$.extend($.ig.Splitter,{locale:{errorPanels:"Le nombre de panneaux ne doit pas \xeatre sup\xe9rieur \xe0 deux.",errorSettingOption:"Erreur lors du r\xe9glage de l'option."}})}})(jQuery);/*!@license
...
*
*/
(function($){$.ig=$.ig||{};if(!$.ig.TileManager){$.ig.TileManager={};$.extend($.ig.TileManager,{locale:{renderDataError:"\xc9chec de la r\xe9cup\xe9ration ou de l'analyse des donn\xe9es.",setOptionItemsLengthError:"The length of the items configurations does not match the number of the tiles."}})}})(jQuery);/*!@license
...
*
*/
(function($){$.ig=$.ig||{};if(!$.ig.Toolbar){$.ig.Toolbar={};$.extend($.ig.Toolbar,{locale:{collapseButtonTitle:"R\xe9duire",expandButtonTitle:"Etendre"}})}})(jQuery);/*!@license
